...
- `spark` may orchestrate every Spark primitive and may use `pi-cue`, `pi-roles`, and Spark SDK packages. It is no longer exposed as a package-level Pi extension; Spark CLI loads it as a built-in SDK host adapter.
