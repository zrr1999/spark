...
- `@zendev-lab/spark-memory` — unified explicit memory capability and `memory({ action })` tool for scoped remember/recall/search/status/forget entries with secret scanning and policy-only prompting.
