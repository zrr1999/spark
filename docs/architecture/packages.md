...
spark-session         # daemon-owned persistent session registry, channel bindings, and mailbox mechanism
spark-channels        # Feishu/Infoflow/QQ Bot adapters, routes, notify (I/O only; no session ownership)
