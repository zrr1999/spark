...
| Foreground live streaming | `test/spark-workflows.test.ts` — `Spark workflow_run streams live onUpdate events before wait=true completion`; artifact `artifact:8f422d38-f1d0-40e3-b095-4825f62a6d74` | Foreground callers receive compact phase/agent/tool updates before terminal result. |
