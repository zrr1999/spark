...
- [`specs/spark-cockpit-remote-access.md`](./specs/spark-cockpit-remote-access.md) — token auth, custom domains, trusted-proxy URL discovery, and PWA install guide for remote Cockpit use.
