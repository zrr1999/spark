...
2. Use root `DESIGN.md` as the product/architecture entry and [`docs/architecture/packages.md`](../architecture/packages.md) for package/dependency ownership details.
