...
| `todo_update`    | `scope: "session" \| "task"`, ops array, optional task selector | task scope requires a current claimed task unless explicit owner   | `spark_update_todos`, `spark_update_task_todos`, `rpiv-todo` |
