...
export class SparkAgentLoop {
   ...
   */
  private drainOutboxIntoMessages(): void {
    ...
    for (const envelope of envelopes) {
      if (envelope.kind === "user") {
        ...
        // Custom messages aren't part of the LLM context proper — they go in
        // as visible system notices via a synthesized user role for now,
