...
import { createId, type ArtifactProjectionPayload } from "@navia-dev/protocol";

/**
 * Maximum byte size for an inline preview embedded in a runner-produced
...
/**
 * Build and persist a canonical Markdown task summary for a runner-executed
 * `task.start.request`. The runner owns the canonical content under
