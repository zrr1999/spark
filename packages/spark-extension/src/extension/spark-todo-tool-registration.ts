...
export function registerSparkTodoTools(
  ...
  registerSparkTool({
    ...
    description:
      "Implementation for task_write({ action: 'todo_update', scope: 'task' }): update plan items attached to this session's one currently claimed unfinished task. Only claimed unfinished tasks can have task plan items modified.",
