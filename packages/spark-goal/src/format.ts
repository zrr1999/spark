import type { GoalStatus, SparkGoal } from "./types.ts";
...
export function formatBudget(goal: SparkGoal): string {
...
export function formatGoalSummary(goal: SparkGoal | null): string {
  if (!goal) {
...
function compactBudgetUsage(goal: SparkGoal): string {
  if (goal.tokenBudget === null) {
...
export function toToolGoal(goal: SparkGoal): GoalToolRecord {
  return {
    goalId: goal.goalId,
    objective: goal.objective,
    status: goal.status,
...
export function remainingTokens(goal: SparkGoal | null): number | null {
...
export function completionBudgetReport(goal: SparkGoal | null): string | null {
...
export function toToolText(goal: SparkGoal | null, includeCompletionBudgetReport = false): string {
