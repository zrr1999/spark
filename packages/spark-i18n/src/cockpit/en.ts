const messages = {
  ...
  sessions: {
    ...
    workbench: {
      ...
      chooseModelHint:
        "Search models or providers. Spark keeps the current conversation and execution state.",
      ...
      progress: "Progress",
      todoList: "TODO list",
      sessionTodoTitle: "Session TODOs",
      sessionTodoBody:
        "Maintained by the TODO tool and retained in the conversation execution history.",
