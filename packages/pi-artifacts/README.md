...
`@zendev-lab/pi-artifacts` owns content-addressed artifact metadata, blobs, provenance, links, and the canonical `artifact` tool for Pi capability packages and host facades.
