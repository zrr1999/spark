...
- `packages/spark-orchestrator`：ready task frontier 调度、dispatch-time role assignment、后台编排状态与 reconciliation。
...
- `spark_status` 和 Spark widget 能以低噪声方式展示当前 project、active tasks、TODO、Spark orchestrator 和 readiness 问题。
