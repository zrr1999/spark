...
import { renderBaseSystemPromptsPrompt } from "../../../../packages/spark/src/extension/spark-builtin-skills.ts";
import { loadSparkMode } from "../../../../packages/spark/src/extension/session-state.ts";
import type { SparkSessionContext } from "../../../../packages/spark/src/extension/session-identity.ts";
