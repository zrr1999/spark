    ...
    try {
      ...
      const ensureRegistration = vi.fn(async () => ({
        config: {
          ...
          displayName: "Test local service",
      ...
      const response = await handleLocalRpcLine(
        ...
        undefined,
        {
          ensureLocalServiceRegistrationForWorkspace: ensureRegistration,
          verifyLocalServiceWorkspaceConnection: verifyConnection,
        },
      );
  ...
  it("rolls back workspace registration when websocket verification fails", async () => {
    ...
    try {
      ...
      const response = await handleLocalRpcLine(
        ...
        {
          ensureLocalServiceRegistrationForWorkspace: ensureRegistration,
          verifyLocalServiceWorkspaceConnection: vi.fn(async () => {
