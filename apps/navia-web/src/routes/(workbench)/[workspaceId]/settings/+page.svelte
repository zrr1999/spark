...
<section class="settings-page" aria-labelledby="settings-title">
  <header class="settings-header">
    <div>
      ...
      <p class="lede">{t.general.lede}</p>
    </div>
    <a class="secondary-action" href="#runner-enrollment">{t.hero.createToken}</a>
  </header>
  ...
  <section class="panel-card" id="runner-enrollment" aria-labelledby="runner-enrollment-title">
    <div class="panel-heading">
      <div>
