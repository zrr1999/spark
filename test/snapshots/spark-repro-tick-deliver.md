...
Next: research "PR submitted", store the findings as an artifact, then call repro({ action: "record", requirementId: "pr-submitted", proof: { kind: "evidence", evidenceRefs: ["artifact:..."] } }).
