...
Next: research "Reproduction claim and acceptance contract frozen", store the findings as an artifact, then call repro({ action: "record", requirementId: "repro-contract-frozen", proof: { kind: "evidence", evidenceRefs: ["artifact:..."] } }).
